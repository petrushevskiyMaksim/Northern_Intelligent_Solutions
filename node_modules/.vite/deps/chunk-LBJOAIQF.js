...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-ILF3NKAU.js";
import {
  capitalize_default
} from "./chunk-N6P7T3TI.js";
import {
  Paper_default,
  integerPropType_default
} from "./chunk-TZUEDJ26.js";
import {
  chainPropTypes
} from "./chunk-ITGWAFDM.js";
import {
  memoTheme_default
} from "./chunk-RL4WIPX5.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var OutlinedInput = React29.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime23.jsxs)(React29.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
var TablePaginationActions = React37.forwardRef(function TablePaginationActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTablePaginationActions"
  });
  ...
  return (0, import_jsx_runtime31.jsxs)(TablePaginationActionsRoot, {
    ref,
    className: clsx_default(classes.root, className),
    ...other,
    children: [showFirstButton && (0, import_jsx_runtime31.jsx)(FirstButtonSlot, {
      onClick: handleFirstPageButtonClick,
      disabled: disabled || page === 0,
      "aria-label": getItemAriaLabel("first", page),
      title: getItemAriaLabel("first", page),
      ...firstButtonSlotProps,
      children: isRtl ? (0, import_jsx_runtime31.jsx)(LastButtonIcon, {
        ...slotProps.lastButtonIcon
      }) : (0, import_jsx_runtime31.jsx)(FirstButtonIcon, {
        ...slotProps.firstButtonIcon
      })
    }), (0, import_jsx_runtime31.jsx)(PreviousButtonSlot, {
      ...
      children: isRtl ? (0, import_jsx_runtime31.jsx)(NextButtonIcon, {
        ...slotProps.nextButtonIcon
      }) : (0, import_jsx_runtime31.jsx)(PreviousButtonIcon, {
        ...slotProps.previousButtonIcon
      })
    }), (0, import_jsx_runtime31.jsx)(NextButtonSlot, {
      ...
      children: isRtl ? (0, import_jsx_runtime31.jsx)(PreviousButtonIcon, {
        ...slotProps.previousButtonIcon
      }) : (0, import_jsx_runtime31.jsx)(NextButtonIcon, {
        ...slotProps.nextButtonIcon
      })
    }), showLastButton && (0, import_jsx_runtime31.jsx)(LastButtonSlot, {
      onClick: handleLastPageButtonClick,
      disabled: disabled || page >= Math.ceil(count / rowsPerPage) - 1,
      "aria-label": getItemAriaLabel("last", page),
      title: getItemAriaLabel("last", page),
      ...lastButtonSlotProps,
      children: isRtl ? (0, import_jsx_runtime31.jsx)(FirstButtonIcon, {
        ...slotProps.firstButtonIcon
      }) : (0, import_jsx_runtime31.jsx)(LastButtonIcon, {
        ...slotProps.lastButtonIcon
      })
    })]
  });
...
true ? TablePaginationActions.propTypes = {
   ...
   * @returns {string}
   */
  getItemAriaLabel: import_prop_types28.default.func.isRequired,
  /**
   ...
   * @ignore
   */
  page: import_prop_types28.default.number.isRequired,
  /**
   * @ignore
   */
  rowsPerPage: import_prop_types28.default.number.isRequired,
  /**
   * @ignore
   */
  showFirstButton: import_prop_types28.default.bool.isRequired,
  /**
   * @ignore
   */
  showLastButton: import_prop_types28.default.bool.isRequired,
  /**
   * @ignore
   */
...
var TablePagination = React38.forwardRef(function TablePagination2(inProps, ref) {
  ...
  return (0, import_jsx_runtime32.jsx)(RootSlot, {
    ...rootSlotProps,
    children: (0, import_jsx_runtime32.jsxs)(ToolbarSlot, {
      ...toolbarSlotProps,
      children: [(0, import_jsx_runtime32.jsx)(SpacerSlot, {
        ...spacerSlotProps
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime32.jsx)(SelectLabelSlot, {
        ...selectLabelSlotProps,
        children: labelRowsPerPage
      }), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime32.jsx)(SelectSlot, {
        variant: "standard",
        ...!selectProps.variant && {
...
true ? TablePagination.propTypes = {
   ...
   */
  ActionsComponent: import_prop_types29.default.elementType,
  /**
  ...
  slotProps: import_prop_types29.default.shape({
    actions: import_prop_types29.default.shape({
    ...
    select: import_prop_types29.default.object,
...
//# sourceMappingURL=chunk-LBJOAIQF.js.map
